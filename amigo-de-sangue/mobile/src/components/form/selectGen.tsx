...
import '../../styles/theme'
import { SelectGenModal } from './selectGenModal';
...
export function SelectGen({visible, onStateSelect}: Props ) {
...
const handleSelectState = (stateSigla: string) => {
  ...
  return (
    <View className='flex-3 mt-3 -ml-5 mb-0 justify-start'>
      <Text className='font-medium text-red-600 mx-2 mb-1'>Gênero</Text>  
