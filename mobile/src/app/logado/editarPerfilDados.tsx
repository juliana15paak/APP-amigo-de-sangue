  ...
  const fetchPerfilData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setValue('dataNascUsuario', data.dataNascUsuario || '');
        setValue('numTelefone', data.numTelefone || '');
        setValue('generoUsuario', data.generoUsuario || '');
        setValue('emailUsuario', data.emailUsuario || '');
        setValue('cpfUsuario', data.cpfUsuario || '');
        setValue('logUsuario', data.logUsuario || '');
        setValue('numLogUsuario', data.numLogUsuario || '');
        setValue('compUsuario', data.compUsuario || '');
        setValue('bairroUsuario', data.bairroUsuario || '');
        setValue('cidadeUsuario', data.cidadeUsuario || '');
        setValue('estadoUsuario', data.estadoUsuario || '');
        setValue('cepUsuario', data.cepUsuario || '');
        setValue('rgUsuario', data.rgUsuario || '');
        setValue('userPhoto', data.fotoUsuario || '');
