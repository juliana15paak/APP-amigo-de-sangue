...
export function Button({ text, variant = "ProximaEtapa", ...rest }: Props & TouchableOpacityProps & VProps) {
  return (
    <View
      ...
      style={{
        marginBottom: variant === "ProximaEtapa" || variant === "SalvarContinuar" || variant === "White" ? RFValue(20) : RFValue(10),
        marginTop: variant === "ProximaEtapa" || variant === "SalvarContinuar" ? RFValue(20) : variant === "White"? RFValue(28) : RFValue(5),
        marginHorizontal: variant === "ProximaEtapa" || variant === "SalvarContinuar"  ? RFValue(28) : variant === "Danger"? RFValue(28) : RFValue(9),
